...
export CNAME_VALUE=${CNAME_VALUE:-"jean-baptiste-lasselle.github.io"}
# export DEPLOYMENT_HUGO_BASE_URL=${DEPLOYMENT_HUGO_BASE_URL:-"https://example.com/gohugo"}
export DEPLOYMENT_HUGO_BASE_URL=${DEPLOYMENT_HUGO_BASE_URL:-"https://jean-baptiste-lasselle.github.io/whoami-web/"}
