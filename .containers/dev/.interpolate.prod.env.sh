...
# second interpolete all env vars in ./.prod.env
cp ./.env.template ./.prod.env

# sed -i "s#CCCCC_PLACEHOLDER#${CCCCCC_PLACEHOLDER}#g" ./.prod.env

# POKUS_USER_NAME=POKUS_USER_NAME_PLACEHOLDER
sed -i "s#POKUS_USER_NAME_PLACEHOLDER#${POKUS_USER_NAME}#g" ./.prod.env
...
sed -i "s#ALPINE_OCI_IMAGE_TAG_PLACEHOLDER#${ALPINE_OCI_IMAGE_TAG}#g" ./.prod.env
# GOLANG_VERSION=GOLANG_VERSION_PLACEHOLDER
sed -i "s#GOLANG_VERSION_PLACEHOLDER#${GOLANG_VERSION}#g" ./.prod.env
# HUGO_VERSION=HUGO_VERSION_PLACEHOLDER
sed -i "s#HUGO_VERSION_PLACEHOLDER#${HUGO_VERSION}#g" ./.prod.env
# GIT_COMMIT_ID=GIT_COMMIT_ID_PLACEHOLDER
sed -i "s#GIT_COMMIT_ID_PLACEHOLDER#${GIT_COMMIT_ID}#g" ./.prod.env
# CICD_BUILD_ID=CICD_BUILD_ID_PLACEHOLDER
sed -i "s#CICD_BUILD_ID_PLACEHOLDER#${CICD_BUILD_ID}#g" ./.prod.env
# CICD_BUILD_TIMESTAMP=CICD_BUILD_TIMESTAMP_PLACEHOLDER
sed -i "s#CICD_BUILD_TIMESTAMP_PLACEHOLDER#${CICD_BUILD_TIMESTAMP}#g" ./.prod.env
# QUAY_OCI_IMAGE_TAG=QUAY_OCI_IMAGE_TAG_PLACEHOLDER
sed -i "s#QUAY_OCI_IMAGE_TAG_PLACEHOLDER#${QUAY_OCI_IMAGE_TAG}#g" ./.prod.env
